...
import { Sparkles, ShoppingBag, Utensils, Building2, ShieldCheck, Zap } from 'lucide-react';
...
const bannerData = {
  't-store': {
    ...
    image: 'https://images.unsplash.com/photo-1556742049-0a67e517d473?auto=format&fit=crop&w=1200&q=80',
    icon: ShoppingBag,
...
const ProductBanner: React.FC<ProductBannerProps> = ({ productId }) => {
  ...
  return (
    <div className="w-full h-full min-h-[420px] rounded-3xl border dark:border-white/15 border-slate-200 dark:bg-[#080808] bg-slate-900 overflow-hidden relative shadow-2xl group transition-all duration-500 flex flex-col justify-between p-6 sm:p-8">
      {/* Promotional Background Image with Dark Vignette */}
